...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['prefix' => 'customer', 'middleware' => ['auth:api', 'customer_is_block']], function () {
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            Route::get('order-status/{order_id}','OrderController@changes_status');
            Route::get('cancel-order/{order_id}','OrderController@cancel_order_cus');
        });
        // Chatting
        ...
        Route::group(['prefix' => 'cart'], function () {
            Route::get('/{region_id?}/{use_wallet?}', 'CartController@listCarts');
