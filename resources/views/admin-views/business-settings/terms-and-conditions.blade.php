        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.business-settings.page-setup.terms-and-conditions')}}" method="post" id="tnc-form">
                    @csrf
                    <label class="input-label" for="tnc">{{translate('English')}} </label>
                    <div class="form-group">
                        <textarea class="ckeditor form-control" name="tnc">{!! $tnc->value !!}</textarea>
                    </div>
                    <label class="input-label" for="japanese_terms_and_conditions">{{translate('Japanese')}}</label>
                    <div class="form-group">
                        <textarea class="ckeditor form-control" name="japanese_terms_and_conditions">{!! $JapaneseTnc->value !!}</textarea>
                    </div>
