...
<body style="-webkit-print-color-adjust:exact !important;print-color-adjust:exact !important;">
	<table width="100%" class="invoice_table">
		<tr style="background: #3e4493;">
			<td>
				<h2 style="margin: 10px 0;color: #fff;text-align: center;font-size: 15px;">請求書</h2>
			</td>
		</tr>
		<tr>
			<td>
				{{--  <p style="margin: 10px 0;color: #000;text-align: right;">日付 : 04 Jan 2024 01:08 am</p>  --}}
				@php 
					$dateTime = new DateTime($order->created_at);
				@endphp
                <p style="margin: 10px 0;color: #000;text-align: right;">日付 : {{$dateTime->format("d M Y h:i a")}}</p>
			</td>
		</tr>
		<tr>
			<td>
				<table width="100%">
					<tr>
						<td width="50%">
							...
							<p style="border-bottom: 2px solid #3e4493;margin: 0; padding: 0 0 10px;"><b>電話番号 </b>
                                {{$order->delivery_address['contact_person_number']}}
                            </p>
							<table width="100%">
								<tr>
									<td width="70%"><h3 style="margin: 0;">支払総額</h3></td>
						...
						<td width="50%" style="padding-left: 30px;">
							...
							<p style="margin:0"><b>電話番号</b>{{$order->shop_detail['phone']}}</p>
			...
			<td>
				<table width="100%" class="invoice_table_product">
					<tr style="background: #a0a3ca;">
						<th width="50%" style="text-align: center;">商品名</th>
						<th width="10%" style="text-align: center;">数量</th>
						<th width="20%" style="text-align: center;">1 台あたりの価格</th>
						<th width="20%" style="text-align: center;">合計金額</th>
					</tr>
					...
					<tr>
						...
						<td width="50%">
							<table width="100%" class="invoice_table_info">
                                ...
                                @endif
								<tr>
									<td width="55%"><h3 style="margin: 0;">合計</h3></td>
