            ...
            <td style="margin:0;padding:0;border:none;border-collapse:collapse;width:46%;vertical-align:bottom;">
                <table style="width:100%;border:none;border-collapse:collapse;margin:0;padding:0;">
                    ...
                    <tr style="width:100%;border:none;border-collapse:collapse;margin:0;padding:0;border-bottom:1px solid #000;">
                        ...
                        <td style="border:none;padding:3px 4px;font-size:22px;line-height:22px;color:#000;font-weight:700;text-align:right;width:40%;min-height:28px;">{{ $sub_total+$updated_total_tax-$order['coupon_discount_amount']-$order['extra_discount'] }}</td>
                    </tr>
                </table>
            </td>
        </tr>
