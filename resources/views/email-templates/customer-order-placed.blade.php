                                ...
                                <tbody>
                                  <tr>
                                    <th class="column_logo" style="mso-line-height-rule: exactly; padding-top: 11px; padding-bottom: 11px;" align="center">
                                      ...
                                      <img src="{{url(Storage::url('restaurant/'.$config['shop_logo']))}}" class="logo " width="224" border="0" style="width: 224px; height: auto !important; display: block; text-align: center; margin: auto;" />
                                      </a>
                                      <!-- Logo : END -->
                                    </th>
                                  </tr>
