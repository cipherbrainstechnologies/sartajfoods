  ...
  <body>
    ...
    <!-->
      <style type="text/css" data-premailer="ignore">
        ...
        [style*="Poppins"] {
          font-family: 'Poppins', -apple-system, BlinkMacSystemFont, 'Segoe UI', Poppins, sans-serif !important;
        }
        [style*="Poppins"] {
          font-family: 'Poppins', -apple-system, BlinkMacSystemFont, 'Segoe UI', Poppins, sans-serif !important;
        }
      ...
      <link href="https://fonts.googleapis.com/css?family=&amp;subset=latin-ext" rel="stylesheet" type="text/css" data-premailer="ignore" />
    ...
    <style type="text/css" data-premailer="ignore">
      ...
      .section.recommended_products .related_products_title h1,
      ...
      .main tr.section:nth-child(1)>th {
      padding-top: 22px;
      padding-bottom: 22px;
      }
      .main tr.section:nth-child(2)>th {
      padding-top: 22px;
      }
      p,
      .column_1_of_2 th p,
        ...
        <tr>
          <th valign="top" style="mso-line-height-rule: exactly;">
            <center style="width: 100%;">
                ...
                <tbody>
                  <tr>
                    <th valign="top" style="mso-line-height-rule: exactly;">
                      ...
                      <table class="section_wrapper header" data-id="header" id="section-header" border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="min-width: 100%;" role="presentation">
                        <tbody>
                          <tr>
                          ...
                          <tr>
                            <td class="section_wrapper_th" style="mso-line-height-rule: exactly;" bgcolor="#ffffff">
                              <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="min-width: 100%;" id="mixContainer" role="presentation">
                                <!-- BATMAN BACKORDER -->
                                <!-- END BATMAN BACKORDER -->
                                <!-- BEGIN SECTION: Heading -->
                                <tbody>
                                  <tr id="section-4664701" class="section heading">
                                    <th style="mso-line-height-rule: exactly; color: #203620; padding: 22px 44px; border-color: #ffffff;" bgcolor="#ffffff">
                                      <table cellspacing="0" cellpadding="0" border="0" width="100%" role="presentation" style="color: #203620; border-color: #ffffff;" bgcolor="#ffffff">
                                        <tbody>
                                  ...
                                  <tr id="section-4664702" class="section introduction">
                                      ...
                                      <span data-key="4664702_introduction_text" class="text" style="text-align: left; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000;">
                                        ...
                                        @if($order->order_status == "pending")
                                          <p style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 11px 0 0;text-align=left">
                                              {{ 'Thank you for your order with Sartaj Foods!' }}<br><br>
                                              {{ 'We\'re excited to confirm that your order has been successfully placed. We will keep you updated and let you know once your order is ready for dispatch.'}}
                                          </p>
                                        ...
                                        @elseif($order->order_status == "processing")
                                          <p style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 11px 0 0;text-align=left">
                                              {{ 'We\'re excited to inform you that your order at Sartaj Foods is now being processed and packaged with care!'}}<br><br>
                                              {{ 'Thank you for your patience and ongoing support! Our team is dedicated to preparing your order with the utmost care and it will be shipped shortly. We’ll keep you informed about its progress.'}}
                                          </p>
                                        @elseif($order->order_status == "canceled")
                                          <p style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 11px 0 0;text-align=left">
                                              {{ 'We regret to inform you that your order with Sartaj Foods has been cancelled. We understand this may be disappointing, and we sincerely apologize for any inconvenience this may have caused.'}}
                                          </p>
                                        ...
                                        @else
                                          <p style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 11px 0 0;text-align=left">
                                            {{'We are pleased to inform you that your order'}}<b>{{$order->id}}</b>{{'has been dispatched and is on its way to you! You can expect to receive your package soon.'}}<br><br>
                                          </p>
                                          <p style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 11px 0 0;text-align=left">
                                            {{'You can monitor the progress of your delivery by using the tracking ID available in your account profile. Just log in to your account and go to the' }}<b>{{"Track Your Order"}}</b>{{'section in the account section to stay informed about your order\'s status.'}}
                                          </p>
                                        @endif
                                  ...
                                  <tr id="section-4664703" class="section divider">
                                    <th style="mso-line-height-rule: exactly; padding: 22px 44px;" bgcolor="#ffffff">
                                      <table cellspacing="0" cellpadding="0" border="0" width="100%" role="presentation">
                                        <tbody>
                                          <tr>
                                            <th style="mso-line-height-rule: exactly; border-top-width: 1px; border-top-color: #e5e5e5; border-top-style: solid;" bgcolor="#ffffff" valign="top">
                                            </th>
                                          </tr>
                                        </tbody>
                                      </table>
                                  ...
                                  <tr id="section-4664704" class="section order_number_and_date">
                                    ...
                                    <th style="mso-line-height-rule: exactly; padding: 11px 44px;" bgcolor="#ffffff">
                                      <table class="table-inner" cellspacing="0" cellpadding="0" border="0" width="100%" style="min-width: 100%;" role="presentation">
                                        <tbody>
                                                ...
                                                <tbody>
                                                  <tr>
                                                    <th colspan="2" class="product-table-h3-wrapper" style="mso-line-height-rule: exactly;" bgcolor="#ffffff" valign="top">
                                                      <h3 data-key="4664705_item" style="font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; color: #203620; font-size: 14px; line-height: 20px; font-weight: 700; text-transform: uppercase; border-bottom-width: 1px; border-bottom-color: #e5e5e5; border-bottom-style: solid; margin: 0;" align="left">{{translate('Items ordered')}}</h3>
                                                    </th>
                                                  </tr>
                                                  <!-- Bold 2 -->
                                                  <!-- end Bold 2 -->
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr>
                                                                  <th class="table-stack product-image-wrapper stack-column-center" width="1" style="mso-line-height-rule: exactly; border-bottom-width: 1px; border-bottom-color: #e5e5e5; border-bottom-style: solid; padding: 11px 11px 11px 0;" bgcolor="#ffffff" valign="middle">
                                                                    ...
                                                                    <img width="105" class="product-image" src="{{str_replace(' ', '%20',$productDetail['image'][0]) ?? ''}}" alt="image" style="vertical-align: middle; text-align: center; width: 105px; max-width: 105px; height: auto !important; border-radius: 1px; padding: 0px;" />
                                                                </a></th>
                                                                    ...
                                                                    <p style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 0;" align="left">
                                                                        ...
                                                                        <br />
                                                                        <span class="muted" style="text-align: center; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 13px; line-height: 22px; font-weight: normal; text-transform: none; color: #7fbb35;"></span>
                                                                    </p>
                                                                    </th>
                                                                    <th class="right line-item-qty" width="1" style="mso-line-height-rule: exactly; white-space: nowrap; padding: 11px 5px 11px 22px;" align="right" bgcolor="#ffffff" valign="top">
                                                                    <p style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 0;" align="right">x {{$order->details[$key]['quantity']}}</p>
                                                                    </th>
                                          ...
                                          <tr>
                                            <th class="pricing-table" style="mso-line-height-rule: exactly;padding: 11px 44px;" bgcolor="#ffffff" valign="top">
                                              <table cellspacing="0" cellpadding="0" border="0" width="100%" style="    width: 600px;min-width: 600px;max-width: 600px;" role="presentation">
                                                <tbody>
                                                  ...
                                                  <tr>
                                                    <th class="table-title" style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 65%; padding: 5px 0;" align="left" bgcolor="#ffffff" valign="top">{{translate('Consumption Tax 8%')}}</th>
                                                    <th class="table-text" style="text-align:right;mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 35%; padding: 5px 0;" align="right" bgcolor="#ffffff" valign="middle">¥{{round($EightPercentTax)}}</th>
                                                  </tr>
                                                  @endif
                                                  @if(!empty($TenPercentTax))
                                                  <tr>
                                                    <th class="table-title" style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 65%; padding: 5px 0;" align="left" bgcolor="#ffffff" valign="top">{{translate('Consumption Tax 10%')}}</th>
                                                    <th class="table-text" style="text-align:right;mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 35%; padding: 5px 0;" align="right" bgcolor="#ffffff" valign="middle">¥{{round($TenPercentTax)}}</th>
                                                  </tr>
                                                  @endif
                                                  @if(!empty($totalDiscount))
                                                  <tr>
                                                    <th class="table-title" style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 65%; padding: 5px 0;" align="left" bgcolor="#ffffff" valign="top">{{translate('Discount Amount')}}</th>
                                                  ...
                                                  <tr>
                                                    <th class="table-title" style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 65%; padding: 5px 0;" align="left" bgcolor="#ffffff" valign="top">{{translate('Redeemed Points')}}</th>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <th class="table-text" style="text-align:right;mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; width: 35%; padding: 5px 0;" align="right" bgcolor="#ffffff" valign="middle">-¥{{$order->coupon_discount_amount }}</th>
                                                  </tr>
                                                  @endif
                                                  <tr class="pricing-table-total-row">
                                                    ...
                                                    <th class="table-text" style="text-align:right;mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 700; text-transform: uppercase; color: #203620; width: 35%; padding: 5px 0;" align="right" bgcolor="#ffffff" valign="middle">¥{{$totalAmt + round($EightPercentTax) +round($TenPercentTax) - $redeem_points}}</th>
                                                  </tr>
                                                </tbody>
                                              </table>
                                            </th>
                                  ...
                                  <tr id="section-4664707" class="section customer_and_shipping_address">
                                          ...
                                          <tr>
                                            ...
                                            <th width="50%" class="column_1_of_2 column_bill_to " style="mso-line-height-rule: exactly;" align="left" bgcolor="#ffffff" valign="top">
                                              <table align="center" border="0" width="100%" cellpadding="0" cellspacing="0" style="min-width: 100%;" role="presentation">
                                                <tbody>
                                                  <tr>
                                                    <th style="mso-line-height-rule: exactly; padding-right: 11px;" align="left" bgcolor="#ffffff" valign="top">
                                                      <h3 data-key="4664707_ship_to" style="font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; color: #203620; font-size: 14px; line-height: 20px; font-weight: 700; text-transform: uppercase; margin: 0;" align="left">{{translate('Shipping Address')}}</h3>
                                                    </th>
                                                  </tr>
                                                  <tr>
                                            ...
                                            <th width="50%" class="column_2_of_2 column_ship_to " style="mso-line-height-rule: exactly;" align="right" bgcolor="#ffffff" valign="top">
                                              <table align="center" border="0" width="100%" cellpadding="0" cellspacing="0" style="min-width: 100%;" role="presentation">
                                                <tbody>
                                                  <tr>
                                                    <th style="mso-line-height-rule: exactly; padding-left: 11px;" align="right" bgcolor="#ffffff" valign="top">
                                                      <h3 data-key="4664707_bill_to" style="font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; color: #203620; font-size: 14px; line-height: 20px; font-weight: 700; text-transform: uppercase; margin: 0;" align="right">{{translate('Customer')}}</h3>
                                                    </th>
                                                  </tr>
                                                  <tr>
                                                    <th class="billing_address " style="mso-line-height-rule: exactly; padding-left: 11px;" align="right" bgcolor="#ffffff" valign="top">
                                                      <p style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 0;" align="right">{{$order->customer['f_name'].' '.$order->customer['l_name'] }}<br />{{$order->delivery_address['address']}}<br /><a href="mailto:{{$order->customer['email']}}" style="color: #7fbb35; text-decoration: none !important; text-underline: none; word-wrap: break-word;">{{$order->customer['email']}}</a>
                                                      </p>
                                                    </th>
                                                  </tr>
                                                </tbody>
                                  ...
                                  <!-- BEGIN SECTION: Order Notes -->
                                  <tr id="section-4664708" class="section order_notes">
                                    <th style="mso-line-height-rule: exactly; padding: 11px 44px;" align="left" bgcolor="#ffffff">
                                    </th>
                                  </tr>
                                  <!-- END SECTION: Order Notes -->
                                  <!-- BEGIN SECTION: Divider -->
                                  <tr id="section-4664709" class="section divider">
                                    <th style="mso-line-height-rule: exactly; padding: 22px 44px;" bgcolor="#ffffff">
                                      <table cellspacing="0" cellpadding="0" border="0" width="100%" role="presentation">
                                        <tbody>
                                          <tr>
                                  ...
                                  <tr id="section-4664711" class="section closing_text">
                                    <th data-key="4664711_closing_text" class="text" style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; padding: 11px 44px;" align="left" bgcolor="#ffffff">
                                      ...
                                      @if($order->order_status == "pending")
                                        ...
                                        @elseif($order->order_status == "canceled")
                                          <p style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 11px 0 0;" text-align="left">
                                          {{ 'If you have any questions or need further assistance, please don\'t hesitate to contact us at 0727511975. We are here to help and will do our best to address any concerns you may have.'}}<br>
                                        ...
                                        @else
                                          <p style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #000000; margin: 11px 0 0;" text-align="left">
                                              {{ 'If you have any questions or need further assistance, please  don\'t  hesitate to contact us at 0727511975. We are here to help and will do our best to address any concerns you may have.'}}<br><br>
                                              {{'Thank you for choosing Sartaj Foods. We hope you enjoy your purchase!'}}<br><br>
                                              <b>{{'Best Regards,'}}<br> </b>
                                              <b>{{'The Sartaj Foods Team'}}</b>
                                          </p> 
                                        @endif
                              ...
                              <table class="section_wrapper footer" data-id="footer" id="section-footer" border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="min-width: 100%;" role="presentation" bgcolor="#ffffff">
                                <tbody>
                                  <tr>
                                    <td class="section_wrapper_th" style="mso-line-height-rule: exactly; padding-top: 0px; padding-bottom: 0px;" bgcolor="#ffffff">
                                      <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="min-width: 100%;" role="presentation">
                                        <tbody>
                                          <tr>
                                            <th class="column_social" data-id="social" style="mso-line-height-rule: exactly;" bgcolor="#ffffff">
                                              <table border="0" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                                <tbody>
                                                  <tr>
                                                    <th class="column_footer_logo footer_logo_wrapper" width="50%" style="mso-line-height-rule: exactly; padding-bottom: 20px;" align="center" bgcolor="#ffffff">
                                                    </th>
                                                  </tr>
                                                </tbody>
                                              </table>
              ...
              <table class="section_wrapper footer" data-id="footer" id="section-footer" border="0" cellpadding="0" cellspacing="0" align="center" style="max-width: 600px; margin: 0 auto;" role="presentation" bgcolor="#3e4493" width="100%">
                <tbody>
                  <tr>
                    <td class="section_wrapper_th" style="mso-line-height-rule: exactly; padding-top: 22px; padding-bottom: 0px;" bgcolor="#3e4493">
                      <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="min-width: 100%;" role="presentation">
                        <tbody>
                          <tr>
                            <th class="column_social" data-id="social" style="mso-line-height-rule: exactly;" bgcolor="#3e4493">
                              <table border="0" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                  <!-- Social Links : BEGIN -->
                                  <tr>
                                    <th class="column_shop_social_icons " width="100%" style="mso-line-height-rule: exactly;" bgcolor="#3e4493">
                                        <h3 data-key="4664707_bill_to" style="font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; color: #ffffff; font-size: 14px; line-height: 20px; font-weight: 700; text-transform: uppercase; margin: 0;" align="center">{{$config['shop_name']}}</h3>
                                        <p style="mso-line-height-rule: exactly; direction: ltr; font-family: &#39;Poppins&#39;,-apple-system,BlinkMacSystemFont,&#39;Segoe UI&#39;,Poppins,sans-serif; font-size: 15px; line-height: 22px; font-weight: 400; text-transform: none; color: #ffffff; margin: 0;" align="center">{{$config['address']}}<br /><a href="tel:072-751-1975" style="color: #7fbb35; text-decoration: none !important; text-underline: none; word-wrap: break-word;">{{$config['phone']}}</a>
                                        </p>
                                    </th>
                                  </tr>
                                </tbody>
                          ...
                          <tr>
                            <th data-id="store-info" style="mso-line-height-rule: exactly;" bgcolor="#3e4493">
                              <table border="0" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                <!-- Social Links : END -->
                              </table>
                            </th>
                          ...
                          <tr>
                            <th height="1" border="0" style="height: 1px; line-height: 1px; font-size: 1px; mso-line-height-rule: exactly; padding: 0;" bgcolor="#3e4493">
                              <img id="open-image" src="https://www.drsquatch.com/tools/emails/open/order-confirmation/1" alt="" width="1" height="1" border="0" />
                            </th>
                          </tr>
                        </tbody>
                      </table>
