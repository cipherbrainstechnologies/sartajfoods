...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Oct 13, 2023 at 07:39 AM
...
(1, 'Iceberg lettuce', 'Iceberg lettuce is a great bridge food for people who don\'t eat enough other vegetables', '[\"2023-10-10-6525481e1b0b1.png\"]', 35, '[]', '5.00', 1, '2023-10-09 13:51:02', '2023-10-11 13:00:13', '[]', '[{\"id\":\"1\",\"position\":1},{\"id\":\"4\",\"position\":2}]', '[]', '3.00', 'percent', 'percent', 'kg', 50, '1.00', 1, 0, 0, 2, 5),
(2, 'Butterhead lettuce', 'Butterhead lettuce is a soft, tasty lettuce variation that gets its name thanks to its buttery flavor!', '[\"2023-10-10-65254837d8113.png\"]', 30, '[{\"type\":\"30\",\"price\":30,\"stock\":100}]', '5.00', 1, '2023-10-09 13:52:42', '2023-10-12 11:42:53', '[\"3\",\"1\"]', '[{\"id\":\"1\",\"position\":1},{\"id\":\"4\",\"position\":2}]', '[{\"name\":\"choice_3\",\"title\":\"asoft,fatty,vasculartissueintheinteriorcavitiesofbonesthatisamajorsiteofbloodcellproduction\",\"options\":[\"30\"]}]', '2.00', 'percent', 'percent', 'kg', 100, '1.00', 1, 0, 0, 2, 10),
(3, 'Barese', 'This white-stemmed heirloom variety is a dwarf type, only reaching about 9 inches tall at maturity.', '[\"2023-10-10-652547e68a06e.png\"]', 45, '[{\"type\":\"45\",\"price\":45,\"stock\":70}]', '5.00', 1, '2023-10-09 13:54:30', '2023-10-09 20:17:34', '[\"2\"]', '[{\"id\":\"1\",\"position\":1},{\"id\":\"5\",\"position\":2}]', '[{\"name\":\"choice_2\",\"title\":\"coldhardyandcancerfighting\",\"options\":[\"45\"]}]', '5.00', 'percent', 'percent', 'kg', 70, '1.00', 1, 0, 0, 0, 5),
(4, 'ordhook Giant', 'Introduced by Burpee in 1934, his mild-flavored cultivar has thick, dark green leaves that are heavily savoyed and quite tender.', '[\"2023-10-10-652547d12ffc0.png\"]', 55, '[{\"type\":\"55\",\"price\":55,\"stock\":70}]', '5.00', 1, '2023-10-09 13:56:08', '2023-10-12 11:42:59', '[\"3\"]', '[{\"id\":\"1\",\"position\":1},{\"id\":\"5\",\"position\":2}]', '[{\"name\":\"choice_3\",\"title\":\"asoft,fatty,vasculartissueintheinteriorcavitiesofbonesthatisamajorsiteofbloodcellproduction\",\"options\":[\"55\"]}]', '5.00', 'percent', 'percent', 'kg', 70, '1.00', 1, 0, 0, 1, 7),
(5, 'Red cabbage', 'The red cabbage is a kind of cabbage, also known as Blaukraut after preparation.', '[\"2023-10-10-652547bae1ee4.png\",\"2023-10-10-652547bae2df9.png\"]', 25, '[{\"type\":\"25\",\"price\":25,\"stock\":120}]', '5.00', 1, '2023-10-09 13:57:42', '2023-10-09 20:16:50', '[\"2\"]', '[{\"id\":\"2\",\"position\":1},{\"id\":\"6\",\"position\":2}]', '[{\"name\":\"choice_2\",\"title\":\"coldhardyandcancerfighting\",\"options\":[\"25\"]}]', '2.00', 'percent', 'percent', 'kg', 120, '1.00', 1, 0, 0, 0, 10),
(6, 'Pointed white cabbage', 'Pointed cabbage, also known as cone, sweetheart, hispi or sugarloaf cabbage is an F1 hybrid form of cabbage with a tapering shape and large delicate leaves varying in colour from yellowish to blue-green.', '[\"2023-10-10-652547a661f21.png\"]', 20, '[{\"type\":\"20\",\"price\":20,\"stock\":100}]', '4.00', 1, '2023-10-09 13:59:02', '2023-10-09 20:16:30', '[\"2\"]', '[{\"id\":\"2\",\"position\":1},{\"id\":\"6\",\"position\":2}]', '[{\"name\":\"choice_2\",\"title\":\"coldhardyandcancerfighting\",\"options\":[\"20\"]}]', '2.00', 'percent', 'percent', 'kg', 100, '1.00', 1, 0, 0, 0, 10),
(7, 'Green Cauliflower', 'This cauliflower is also known as ‘broccoflower’ as it is a cross between broccoli and cauliflower and comes in various varieties.', '[\"2023-10-10-6525479466132.png\"]', 42, '[{\"type\":\"42\",\"price\":42,\"stock\":70}]', '5.00', 1, '2023-10-09 14:04:09', '2023-10-09 20:16:12', '[\"3\",\"2\"]', '[{\"id\":\"2\",\"position\":1},{\"id\":\"7\",\"position\":2}]', '[{\"name\":\"choice_3\",\"title\":\"asoft,fatty,vasculartissueintheinteriorcavitiesofbonesthatisamajorsiteofbloodcellproduction\",\"options\":[\"42\"]}]', '2.00', 'percent', 'percent', 'kg', 70, '1.00', 1, 1, 0, 0, 5),
(8, 'White Cauliflower', 'This is one of the common types of cauliflowers that you can see in the vegetable market and is found in abundance in India.', '[\"2023-10-10-652547839213e.png\"]', 35, '[{\"type\":\"35\",\"price\":35,\"stock\":80}]', '5.00', 1, '2023-10-09 14:05:26', '2023-10-09 20:15:55', '[\"1\"]', '[{\"id\":\"2\",\"position\":1},{\"id\":\"7\",\"position\":2}]', '[{\"name\":\"choice_1\",\"title\":\"highanti-oxidantcapacity\",\"options\":[\"35\"]}]', '3.00', 'percent', 'percent', 'kg', 80, '1.00', 1, 0, 0, 0, 10),
(9, 'Broccolini', 'Think broccoli but on thinner, longer stalks with smaller heads and a sweeter taste. It’s a cross between broccoli and Chinese broccoli.', '[\"2023-10-10-6525476fa80e7.png\"]', 39, '[{\"type\":\"39\",\"price\":39,\"stock\":50}]', '7.00', 1, '2023-10-09 14:07:24', '2023-10-09 20:15:35', '[\"3\"]', '[{\"id\":\"2\",\"position\":1},{\"id\":\"8\",\"position\":2}]', '[{\"name\":\"choice_3\",\"title\":\"asoft,fatty,vasculartissueintheinteriorcavitiesofbonesthatisamajorsiteofbloodcellproduction\",\"options\":[\"39\"]}]', '3.00', 'percent', 'percent', 'kg', 50, '1.00', 1, 0, 0, 0, 5),
(10, 'Romanesco broccoli', 'Think of flower buds that are spikey and exotic looking. That’s romanesco. It’s bitter and crunchy like regular broccoli but a bit earthier.', '[\"2023-10-10-6525475e311bd.png\",\"2023-10-10-6525475e322c3.png\"]', 45, '[{\"type\":\"45\",\"price\":45,\"stock\":50}]', '7.00', 1, '2023-10-09 14:08:47', '2023-10-09 20:15:18', '[\"3\"]', '[{\"id\":\"2\",\"position\":1},{\"id\":\"8\",\"position\":2}]', '[{\"name\":\"choice_3\",\"title\":\"asoft,fatty,vasculartissueintheinteriorcavitiesofbonesthatisamajorsiteofbloodcellproduction\",\"options\":[\"45\"]}]', '3.00', 'percent', 'percent', 'kg', 50, '1.00', 1, 0, 0, 0, 5),
(11, 'Turban Squash', 'hese funny-looking pumpkins are a variety of winter squash that can grow up to 5 pounds. They\'re identifiable by their unusual shape—it almost looks like one squash bursting out of another one.', '[\"2023-10-10-652547415c6aa.png\"]', 120, '[{\"type\":\"120\",\"price\":120,\"stock\":30}]', '5.00', 1, '2023-10-09 14:10:25', '2023-10-09 20:14:49', '[\"1\"]', '[{\"id\":\"3\",\"position\":1},{\"id\":\"9\",\"position\":2}]', '[{\"name\":\"choice_1\",\"title\":\"highanti-oxidantcapacity\",\"options\":[\"120\"]}]', '3.00', 'percent', 'percent', 'kg', 30, '1.00', 1, 0, 0, 0, 5),
(12, 'Field Trip F1 Hybrid', 'Weighing in at 5 to 7 pounds each, with long, sturdy stems, these orange gourds are perfect for kids to grab and go.', '[\"2023-10-10-65254729189ac.png\"]', 100, '[{\"type\":\"100\",\"price\":100,\"stock\":69}]', '5.00', 1, '2023-10-09 14:11:21', '2023-10-09 20:14:25', '[\"1\"]', '[{\"id\":\"3\",\"position\":1},{\"id\":\"9\",\"position\":2}]', '[{\"name\":\"choice_1\",\"title\":\"highanti-oxidantcapacity\",\"options\":[\"100\"]}]', '3.00', 'percent', 'percent', 'kg', 69, '1.00', 1, 1, 0, 0, 10),
(13, 'CLASSIC GREEN ZUCCHINI', 'The classic green zucchini is the most common type of zucchini found in grocery stores. It has a dark green skin with white flesh and is oblong or cylindrical in shape.', '[\"2023-10-10-65254718c306c.png\",\"2023-10-10-65254718c7e52.png\"]', 70, '[{\"type\":\"70\",\"price\":70,\"stock\":70}]', '5.00', 1, '2023-10-09 14:13:25', '2023-10-09 20:14:08', '[\"3\"]', '[{\"id\":\"3\",\"position\":1},{\"id\":\"10\",\"position\":2}]', '[{\"name\":\"choice_3\",\"title\":\"asoft,fatty,vasculartissueintheinteriorcavitiesofbonesthatisamajorsiteofbloodcellproduction\",\"options\":[\"70\"]}]', '3.00', 'percent', 'percent', 'kg', 70, '1.00', 1, 2, 0, 0, 5),
(14, 'GADZUKES ZUCCHINI', 'Gadzukes zucchinis are a hybrid variety that is a cross between a zucchini and a cucumber. They are similar in appearance to regular zucchinis, but they have a slightly lighter green color and a more cylindrical shape.', '[\"2023-10-09-65252e49ba1b9.png\"]', 75, '[{\"type\":\"75\",\"price\":75,\"stock\":97}]', '7.00', 1, '2023-10-09 14:14:27', '2023-10-09 18:28:17', '[\"3\"]', '[{\"id\":\"3\",\"position\":1},{\"id\":\"10\",\"position\":2}]', '[{\"name\":\"choice_3\",\"title\":\"asoft,fatty,vasculartissueintheinteriorcavitiesofbonesthatisamajorsiteofbloodcellproduction\",\"options\":[\"75\"]}]', '5.00', 'percent', 'percent', 'kg', 97, '1.00', 1, 1, 0, 0, 10);
