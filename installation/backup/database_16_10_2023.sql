...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  `location` varchar(255) DEFAULT NULL,
  `substrack stock` enum('yes','no') NOT NULL DEFAULT 'yes',
